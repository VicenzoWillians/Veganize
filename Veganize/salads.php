        ...
        <div class="container veganize">
            <div class="row content-mobile justify-content-center">
                <div class="col-12 text-secondary text-center my-3">
                  <h1 id="o-movimento" style="color:#6C757D;">SALADAS</h1>
                </div>
                <hr class="divider">
                    <?php
                        include('inc/conexao.inc');

                        $consulta = "SELECT * FROM dados_receita where status_receita = '1' and categoria_receita = '65'";
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-horizontal">
                                                    <div class="img-square-wrapper">
                                                        <img src="images/categories/salads.jpg" class="card-img img-horizontal" alt="Saladas">
                                                    </div>
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-12 center-flex my-4">
                                                            <a href="recipe_view.php?id=' . $resultado['id_receita'] .'" class="btn btn-contact btn-primary">
                                                                Ver Receita
                                                            </a>
                                                        </div>
                                                    </div>
