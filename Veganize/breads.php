        ...
        <div class="container veganize">
            <div class="row content-mobile justify-content-center">
                <div class="col-12 text-secondary text-center my-3">
                  <h1 id="o-movimento" style="color:#6C757D;">PÃES</h1>
                </div>
                <hr class="divider">
                    <?php
                        include('inc/conexao.inc');

                        $consulta = "SELECT * FROM dados_receita where status_receita = '1' and categoria_receita = '55'";
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-horizontal">
                                                    <div class="img-square-wrapper">
                                                        <img src="images/categories/breads.jpg" class="card-img img-horizontal" alt="Pães">
                                                    </div>
                                                    <div class="card-body">
